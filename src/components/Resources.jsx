          ...
          {curatedResources.map((res, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative p-5 sm:p-7 rounded-none border border-l-2 border-l-primary transition-all duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer ${
                  isHovered
              ...
              >
                {/* PCB Node Indicator */}
                <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-10 rounded-r-none transition-all duration-300 ${
                ...
                <div className="flex items-start sm:items-center gap-4 sm:gap-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className={`px-2 py-0.5 rounded-none text-[9px] font-mono font-bold uppercase tracking-wider transition-colors ${
                ...
                <div className="flex items-center justify-between sm:justify-end gap-6 pt-3 sm:pt-0 border-t sm:border-t-0 border-border/40">
                  ...
                  <a
                    href={res.url}
                    className={`px-4 py-2 rounded-none text-xs font-brand uppercase tracking-wider font-semibold inline-flex items-center gap-2 transition-all ${
                      isHovered
